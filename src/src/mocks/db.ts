import { Project, ProjectType, ProjectStatus, Document, DocumentStatus, Inspection, InspectionType, InspectionResult, Certificate, CertificateType, User, UserRole, Unit, RequirementSet, RequirementItem, ReviewComment, CAPA, CAPAStatus, AccessToken, Role, Scope, Permission, AuditEvent, SecurityLog, Report, ReportSchedule, KPI, Waiver, Closure, ClosureType, DigitalSignature, SealRecord, Task, TaskType, TaskStatus } from '../features/projects/types';
